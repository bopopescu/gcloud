...
class ComputeProjectsMoveDiskRequest(messages.Message):
  ...
  diskMoveRequest = messages.MessageField('DiskMoveRequest', 1)
  project = messages.StringField(2, required=True)


class ComputeProjectsMoveInstanceRequest(messages.Message):
  ...
  instanceMoveRequest = messages.MessageField('InstanceMoveRequest', 1)
  project = messages.StringField(2, required=True)
...
class DiskMoveRequest(messages.Message):
  ...
  destinationZone = messages.StringField(1)
  targetDisk = messages.StringField(2)
...
class InstanceMoveRequest(messages.Message):
  ...
  destinationZone = messages.StringField(1)
  targetInstance = messages.StringField(2)
