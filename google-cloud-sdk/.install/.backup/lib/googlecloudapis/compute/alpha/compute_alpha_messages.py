...
class AttachedDiskInitializeParams(messages.Message):
  ...
  Enums:
    DiskStorageTypeValueValuesEnum: Storage type of the disk.  NOTE: when
      backporting InitializeParams check to see whether this field should
      remain hidden. It is likely that SSD support will not ship at the same
      time as create-on-create so we don't want to unhide it.

  Fields:
    diskName: Specifies the disk name. If not specified, the default is to use
      the name of the instance.
    diskSizeGb: Specifies the size of the disk in base-2 GB.
    diskStorageType: Storage type of the disk.  NOTE: when backporting
      InitializeParams check to see whether this field should remain hidden.
      It is likely that SSD support will not ship at the same time as create-
      on-create so we don't want to unhide it.
  ...
  class DiskStorageTypeValueValuesEnum(messages.Enum):
    """Storage type of the disk.  NOTE: when backporting InitializeParams
    check to see whether this field should remain hidden. It is likely that
    SSD support will not ship at the same time as create-on-create so we don't
    want to unhide it.
...
class VpnTunnel(messages.Message):
  ...
  id = messages.IntegerField(4, variant=messages.Variant.UINT64)
  ikeVersion = messages.IntegerField(5, variant=messages.Variant.INT32)
  kind = messages.StringField(6, default=u'compute#vpnTunnel')
  name = messages.StringField(7)
  peerIp = messages.StringField(8)
  region = messages.StringField(9)
  selfLink = messages.StringField(10)
  sharedSecret = messages.StringField(11)
  sharedSecretHash = messages.StringField(12)
  status = messages.EnumField('StatusValueValuesEnum', 13)
  targetVpnGateway = messages.StringField(14)
