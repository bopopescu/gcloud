  ...
  class DeveloperProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      ...
      self._method_configs = {
          'Internalcreateproject': base_api.ApiMethodInfo(
              http_method=u'POST',
              method_id=u'developerprojects.developerProjects.internalcreateproject',
              ordered_params=[],
              path_params=[],
              query_params=[],
              relative_path=u'developerProjects/internalcreateproject',
              request_field='<request>',
              request_type_name=u'CreateProjectRequest1',
    ...
    def Internalcreateproject(self, request, global_params=None):
      """Creates a project resource. This should produce the same project as CreateProject.

      Args:
        request: (CreateProjectRequest1) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Project) The response message.
      """
      config = self.GetMethodConfig('Internalcreateproject')
...
. This method supports patch semantics.
  ...
  class V1Service(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(DeveloperprojectsV1.V1Service, self).__init__(client)
      self._method_configs = {
          'GetIamPolicy': base_api.ApiMethodInfo(
              http_method=u'POST',
              method_id=u'developerprojects.v1.getIamPolicy',
              ordered_params=[u'resource'],
              path_params=[u'resource'],
              query_params=[],
              relative_path=u'v1/{+resource}:getIamPolicy',
              request_field='',
              request_type_name=u'DeveloperprojectsV1GetIamPolicyRequest',
              response_type_name=u'Policy',
              supports_download=False,
          ),
          'SetIamPolicy': base_api.ApiMethodInfo(
              http_method=u'POST',
              method_id=u'developerprojects.v1.setIamPolicy',
              ordered_params=[u'resource'],
              path_params=[u'resource'],
              query_params=[],
              relative_path=u'v1/{+resource}:setIamPolicy',
              request_field=u'setPolicyRequest',
              request_type_name=u'DeveloperprojectsV1SetIamPolicyRequest',
              response_type_name=u'Policy',
              supports_download=False,
          ),
          }
    ...
    def GetIamPolicy(self, request, global_params=None):
      """Returns the IAM access control policy for specified project. Resource should be in format: "/projectid" Uses POST instead of GET because Protiary v2 can't support repeated messages in GET requests.

      Args:
        request: (DeveloperprojectsV1GetIamPolicyRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
    ...
    def SetIamPolicy(self, request, global_params=None):
      """Sets the IAM access control policy for the specified project. Resource should be in format: "/projectid".

      Args:
        request: (DeveloperprojectsV1SetIamPolicyRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Policy) The response message.
      """
