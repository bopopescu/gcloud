...
class Execution(messages.Message):
  ...
  - a jenkins job with a build step followed by a test step  An Execution can
  be updated until its state is set to COMPLETE at which point it becomes
...
class Image(messages.Message):
  ...
  error = messages.MessageField('Status', 1)
  sourceImage = messages.MessageField('ToolOutputReference', 2)
  stepId = messages.StringField(3)
  thumbnail = messages.MessageField('Thumbnail', 4)
...
class ListStepThumbnailsResponse(messages.Message):
  ...
  thumbnails = messages.MessageField('Image', 2, repeated=True)
...
class Thumbnail(messages.Message):
  ...
  heightPx = messages.IntegerField(3, variant=messages.Variant.INT32)
  widthPx = messages.IntegerField(4, variant=messages.Variant.INT32)
...
class ToolresultsProjectsHistoriesExecutionsStepsThumbnailsListRequest(messages.Message):
  ...
  pageToken = messages.StringField(4)
  projectId = messages.StringField(5, required=True)
  stepId = messages.StringField(6, required=True)
