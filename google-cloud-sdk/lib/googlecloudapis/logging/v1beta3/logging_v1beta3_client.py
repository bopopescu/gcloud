...
class LoggingV1beta3(base_api.BaseApiClient):
  ...
  class ProjectsLogServicesSinksService(base_api.BaseApiService):
    ...
    def Create(self, request, global_params=None):
      """Create the specified log service sink resource. Requires https://www.googleapis.com/auth/logging.admin scope.
  ...
  class ProjectsLogsSinksService(base_api.BaseApiService):
    ...
    def Create(self, request, global_params=None):
      """Create the specified log sink resource. Requires https://www.googleapis.com/auth/logging.admin scope.
  ...
  class ProjectsMetricsService(base_api.BaseApiService):
    ...
    def Create(self, request, global_params=None):
      """Create the specified log metric resource. Requires https://www.googleapis.com/auth/logging.admin scope.
