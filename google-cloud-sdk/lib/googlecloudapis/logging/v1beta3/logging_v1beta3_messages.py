...
class LoggingProjectsLogEntriesListRequest(messages.Message):
  ...
  Fields:
    ...
    pageToken: An opaque token obtained from a prior ListLogEntries response
      ...
      original request.
    projectsId: Part of `projectId`. The project resource from which to
...
class LoggingProjectsLogServicesIndexesListRequest(messages.Message):
  ...
  Fields:
    ...
    logServicesId: Part of `service`. See documentation of `projectsId`.
    ...
    projectsId: Part of `service`. A log service resource whose service
...
class LoggingProjectsLogServicesListRequest(messages.Message):
  ...
  Fields:
    ...
    pageToken: An optional next_page_token from a previous
      ...
      not empty.
    projectsId: Part of `projectId`. The project resource for which to list
      the services.
  """
...
class LoggingProjectsLogServicesSinksCreateRequest(messages.Message):
  ...
  Fields:
    ...
    projectsId: Part of `sinkName`. The sink to create.
...
class LoggingProjectsLogServicesSinksDeleteRequest(messages.Message):
  ...
  Fields:
    logServicesId: Part of `sink`. See documentation of `projectsId`.
    projectsId: Part of `sink`. The sink to delete.
    sinksId: Part of `sink`. See documentation of `projectsId`.
  """
...
class LoggingProjectsLogServicesSinksGetRequest(messages.Message):
  ...
  Fields:
    logServicesId: Part of `sink`. See documentation of `projectsId`.
    projectsId: Part of `sink`. The sink to return.
    sinksId: Part of `sink`. See documentation of `projectsId`.
  """
...
class LoggingProjectsLogServicesSinksListRequest(messages.Message):
  ...
  Fields:
    logServicesId: Part of `service`. See documentation of `projectsId`.
    projectsId: Part of `service`. The service for which to list sinks.
  """
...
class LoggingProjectsLogsDeleteRequest(messages.Message):
  ...
  Fields:
    logsId: Part of `log`. See documentation of `projectsId`.
    projectsId: Part of `log`. The log resource to delete.
  """
...
class LoggingProjectsLogsEntriesWriteRequest(messages.Message):
  ...
  Fields:
    logsId: Part of `log`. See documentation of `projectsId`.
    projectsId: Part of `log`. The log resource into which to insert the log
      entries. If the log resource name contains characters that are illegal
      in a URL (for example, "/") they must be URL-encoded (for example, as
      "%2F").
...
class LoggingProjectsLogsListRequest(messages.Message):
  ...
  Fields:
    ...
    projectsId: Part of `projectId`. The project ID for which to list the log
      resources.
...
class LoggingProjectsLogsSinksDeleteRequest(messages.Message):
  ...
  Fields:
    logsId: Part of `sink`. See documentation of `projectsId`.
    projectsId: Part of `sink`. The sink to delete.
    sinksId: Part of `sink`. See documentation of `projectsId`.
  """
...
class LoggingProjectsLogsSinksListRequest(messages.Message):
  ...
  Fields:
    logsId: Part of `log`. See documentation of `projectsId`.
    projectsId: Part of `log`. The log for which to list sinks.
  """
...
class LoggingProjectsMetricsCreateRequest(messages.Message):
  ...
  Fields:
    ...
    projectsId: Part of `metricName`. The metric to create.
  """
...
class LoggingProjectsMetricsDeleteRequest(messages.Message):
  ...
  Fields:
    metricsId: Part of `metric`. See documentation of `projectsId`.
    projectsId: Part of `metric`. The metric to delete.
  """
...
class LoggingProjectsMetricsGetRequest(messages.Message):
  ...
  Fields:
    metricsId: Part of `metric`. See documentation of `projectsId`.
    projectsId: Part of `metric`. The metric to return.
  """
...
class LoggingProjectsMetricsListRequest(messages.Message):
  ...
  Fields:
    ...
    projectsId: Part of `projectId`. The project ID for which to list metrics.
  """
