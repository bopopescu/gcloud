...
class InstanceGroupManager(messages.Message):
  ...
  fingerprint = messages.BytesField(5)
  group = messages.StringField(6)
  id = messages.IntegerField(7, variant=messages.Variant.UINT64)
  instanceTemplate = messages.StringField(8)
  kind = messages.StringField(9, default=u'replicapool#instanceGroupManager')
  name = messages.StringField(10)
  selfLink = messages.StringField(11)
  targetPools = messages.StringField(12, repeated=True)
  targetSize = messages.IntegerField(13, variant=messages.Variant.INT32)
